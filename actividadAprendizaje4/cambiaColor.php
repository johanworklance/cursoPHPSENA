...
<html> 
     ...
     */
    if(isset($_GET['letra'])){
        echo "<br>La letra ".$_GET['letra']." tiene este mensaje <b>".$_GET['mensaje']."</b>"; 
    } 
    if (isset($_GET['colorFondo']) ) {
        ...
        . "<br />";
        $letras=["r"=>"robar plata","l"=>"lavar ropa","b"=>"bailar salsa","j"=>"jugar beisbol"];
        echo "<br>Seleccione una letra<br>";
        foreach($letras as $letra=> $mensaje){
            echo "<a href='cambiaColor.php?mensaje=$mensaje&letra=$letra'><b>$letra</b></a><br>";
        }
    }
    ?>
</body>
